...
export const InstagramIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="#fff"
      d="M128 88a40 40 0 1 0 40 40 40 40 0 0 0-40-40zm0 64a24 24 0 1 1 24-24 24 24 0 0 1-24 24zm48-78a9.9 9.9 0 1 1-9.9 9.9A9.9 9.9 0 0 1 176 74zM128 52c26.5 0 29.7.1 40.1.6a54 54 0 0 1 18.2 3.3 31 31 0 0 1 17.8 17.8 54 54 0 0 1 3.3 18.2c.5 10.4.6 13.6.6 40.1s-.1 29.7-.6 40.1a54 54 0 0 1-3.3 18.2 31 31 0 0 1-17.8 17.8 54 54 0 0 1-18.2 3.3c-10.4.5-13.6.6-40.1.6s-29.7-.1-40.1-.6a54 54 0 0 1-18.2-3.3 31 31 0 0 1-17.8-17.8 54 54 0 0 1-3.3-18.2c-.5-10.4-.6-13.6-.6-40.1s.1-29.7.6-40.1a54 54 0 0 1 3.3-18.2A31 31 0 0 1 69.7 56a54 54 0 0 1 18.2-3.3C98.3 52.1 101.5 52 128 52m0-24c-27 0-30.4.1-41.1.6a78 78 0 0 0-26 4.8A55 55 0 0 0 38 38a78 78 0 0 0-4.8 26c-.5 10.7-.6 14.1-.6 41.1s.1 30.4.6 41.1a78 78 0 0 0 4.8 26A55 55 0 0 0 60.9 218a78 78 0 0 0 26 4.8c10.7.5 14.1.6 41.1.6s30.4-.1 41.1-.6a78 78 0 0 0 26-4.8 55 55 0 0 0 22.9-22.9 78 78 0 0 0 4.8-26c.5-10.7.6-14.1.6-41.1s-.1-30.4-.6-41.1a78 78 0 0 0-4.8-26A55 55 0 0 0 195.1 38a78 78 0 0 0-26-4.8C158.4 28.1 155 28 128 28z"
    />
  </svg>
);
